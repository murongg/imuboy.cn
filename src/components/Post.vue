...
<template>
  <div v-if="frontmatter.display ?? frontmatter.title" class="prose m-auto mb-8">
    ...
    <p v-if="frontmatter.date" class="opacity-50 text-left !-mt-2">
      {{ formatDate(frontmatter.date) }} <span v-if="frontmatter.duration">· {{ frontmatter.duration }}</span>
    </p>
    <p v-if="frontmatter.subtitle" class="opacity-50 text-left italic">
  ...
  <div v-if="route.path !== '/'" class="prose m-auto text-left mt-8 mb-8">
    <br>
